...
image: kernel bootsect setup ./tools/build proc_1.bin proc_2.bin proc_3.bin proc_4.bin proc_5.bin
	./tools/build bootsect setup kernel 5 proc_1.bin proc_2.bin proc_3.bin proc_4.bin proc_5.bin
